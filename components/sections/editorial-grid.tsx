      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-24">
          ...
          <div className="col-span-1 md:col-span-5 flex flex-col justify-center pr-0 md:pr-12">
            ...
            >
              <h2 className="text-7xl md:text-8xl font-bold leading-[0.8] mb-8">
                Seek <br />
              ...
              <a href="#" className="text-sm tracking-widest border-b border-white/30 pb-1 self-start hover:border-white transition-colors">
                Read Our Mission
              </a>
            </motion.div>
          </div>
          ...
          <div className="col-span-1 md:col-span-7 relative">
            ...
            >
              ...
              {/* Floating Quote */}
              <div className="absolute -bottom-12 -left-12 bg-white text-black p-8 max-w-xs hidden md:block z-20 shadow-2xl rounded-xl">
                <p className="font-serif italic text-2xl leading-tight mb-4">
                  &ldquo;Faith is seeing light with your heart.&rdquo;
                </p>
                <p className="text-xs tracking-widest opacity-60">— Pastor Jay</p>
              </div>
            </motion.div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
          <div className="col-span-1 md:col-span-4">
             ...
             <div className="mt-4 border-t border-white/20 pt-4">
                <h4 className="text-xl font-bold">Youth Ministry</h4>
          ...
          <div className="col-span-1 md:col-span-2 hidden md:block">
             <div className="flex flex-col h-full justify-between py-4 border-l border-white/10 pl-8">
               <span className="vertical-text text-xs tracking-[0.5em] text-white/30">
                 Established MMXXIV
               </span>
             </div>
          </div>
