...
export function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      {/* Background Video (portrait src — object-cover fills the landscape frame) */}
      ...
      <div className="container relative z-20 px-6 text-center">
        ...
        >
          <h2 className="text-xs md:text-sm tracking-[0.3em] text-white/70 mb-6">
          ...
          <p className="max-w-xl mx-auto text-lg md:text-xl font-serif italic text-white/80 mb-12 leading-relaxed">
            &ldquo;Transforming and restoring lives, raising responsible overcomers.&rdquo;
          </p>

          <div className="flex flex-col md:flex-row items-center justify-center gap-6">
            <Button className="h-14 px-8 rounded-full bg-white text-black hover:bg-white/90 tracking-widest text-sm">
              Join us Sunday <ArrowRight className="ml-2 w-4 h-4" />
            </Button>
            <Button variant="outline" className="h-14 px-8 rounded-full border-white/20 text-white hover:bg-white/10 tracking-widest text-sm group">
        ...
        >
          <div className="text-left">
            <span className="block text-xs text-white/40 tracking-widest mb-1">Service Times</span>
            <span className="block text-xl font-bold">Sunday 10AM</span>
          </div>
          <div className="h-16 w-[1px] bg-gradient-to-b from-transparent via-white/30 to-transparent mx-auto"></div>
          <div className="text-right">
            <span className="block text-xs text-white/40 tracking-widest mb-1">Location</span>
            <span className="block text-xl font-bold">Ennerdale St, Parklands</span>
          </div>
        </motion.div>
      </div>
    </section>
