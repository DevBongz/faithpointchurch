...
import preacherImg from "@assets/generated_images/preacher_on_stage_black_and_white.png";
import bibleImg from "@assets/generated_images/bible_study_black_and_white.png";
...
const series = [
  ...
  { title: "Deep Waters", subtitle: "Faith in the Unknown", img: preacherImg } // Reusing for variety
];
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="pt-32 pb-20 container mx-auto px-6">
        ...
        {/* Featured Series Carousel (Static for Mockup) */}
        <div className="mb-24">
