...
const img1 = "/images/bible_study_black_and_white.png";
const img2 = "/images/worship_moment_black_and_white.png";
const img3 = "/images/community_gathering_black_and_white.png";
